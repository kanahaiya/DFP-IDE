...
import type { RubyPreset } from '@/lib/ruby/presets';

interface RubyPresetsPanelProps {
  presets: RubyPreset[];
  onApplyPreset: (presetId: string) => void;
}

export function RubyPresetsPanel({ presets, onApplyPreset }: RubyPresetsPanelProps) {
  return (
